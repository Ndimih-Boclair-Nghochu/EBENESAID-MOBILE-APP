...
export default function StaffVerificationScreen() {
  const query = useQuery<unknown>({
    queryKey: ['/api/admin/verification', 'staff'],
  ...
  if (query.isLoading) {
    return <PartnerLoadingScreen portalName="Verification Queue" subtitle="Loading verification queue." />;
  }
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      <FlashList<PartnerRecord>
        ...
        ListHeaderComponent={<View style={styles.content}><PartnerHeader portalName="Verification Queue" subtitle="Review partner verification requests." /></View>}
